...
function ytpp_settings() {
    ...
    ?>
    <div class="wrap">
        <h2><?php esc_html_e( 'Playlist Player for YouTube Settings', 'youtube-playlist-player' ); ?></h2>
        ...
        <?php if ( (string) $tab === 'dashboard' ) { ?>
            <h3>Thank you for using Playlist Player for YouTube!</h3>
            ...
            <h3><?php esc_html_e( 'About Playlist Player for YouTube', 'youtube-playlist-player' ); ?></h3>
            ...
            <form method="post" action="">
                ...
                <p>
                    <input type="checkbox" name="ytpp_rel" id="ytpp_rel" value="1" <?php checked( 1, (int) get_option( 'ytpp_rel' ) ); ?>> <label for="ytpp_rel">Show suggested videos when the video finishes</label>
                </p>
                <p>
                    <input type="checkbox" name="ytpp_info" id="ytpp_info" value="1" <?php checked( 1, (int) get_option( 'ytpp_info' ) ); ?>> <label for="ytpp_info">Show video title and player actions</label>
                </p>
                <p>
                    <input type="checkbox" name="ytpp_controls" id="ytpp_controls" value="1" <?php checked( 1, (int) get_option( 'ytpp_controls' ) ); ?>> <label for="ytpp_controls">Show player controls</label>
                </p>
                <p>
                    <input type="checkbox" name="ytpp_privacy" id="ytpp_privacy" value="1" <?php checked( 1, (int) get_option( 'ytpp_privacy' ) ); ?>> <label for="ytpp_privacy">Enable privacy-enhanced mode</label>
